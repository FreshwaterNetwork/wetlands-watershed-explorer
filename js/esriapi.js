define([
  ...
  return declare(null, {
    esriApiFunctions: function (t) {
      ...
      t.dynamicLayer2 = new ArcGISDynamicMapServiceLayer(t.url, {
        opacity: 0.7,
      });
      ...
      t.dynamicLayer.on("load", function () {
        ...
        $("#" + t.id + "chosenSingle")
          .chosen({ allow_single_deselect: true, width: "65px" })
          .change(function (c) {
      ...
      $(".wfa-helpLinkText")
        ...
        .on("click", function (c) {
          ...
          if (
            c.currentTarget.id == "dijit_layout_ContentPane_0learnMoreButton"
          ) {
