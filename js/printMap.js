define([
  ...
  return declare(null, {
    drawOptions: function (t) {
      ...
      t.symbols.polyline = new SimpleLineSymbol(
        "solid",
        new Color([255, 128, 0]),
        2
      );
      t.symbols.polygon = new SimpleFillSymbol().setColor(
        new Color([255, 0, 0, 0.0])
      );
      t.symbols.polygon.setOutline(
        new SimpleLineSymbol("solid", new Color([17, 124, 7]), 3)
      );
      t.symbols.circle = new SimpleFillSymbol().setColor(
        new Color([255, 0, 180, 0])
      );
      t.symbols.circle.setOutline(
        new SimpleLineSymbol("solid", new Color([9, 50, 196]), 3)
      );
      t.symbols.rectangle = new SimpleFillSymbol().setColor(
        new Color([0, 0, 180, 0.0])
      );
      t.symbols.rectangle.setOutline(
        new SimpleLineSymbol("solid", new Color([196, 37, 9]), 3)
      );
      ...
      $.each(
        $("#dijit_layout_ContentPane_0drawingWrapper .dijitButton"),
        function (i, v) {
          $(v).addClass("button");
          $(v).css("padding", "0");
