    ...
    infographicText: function (t) {
      t.infographicText = {
        ...
        "Overall Feasibility_wet":
          "Overall Feasibility -  Potentially restorable wetlands (PRWs) are ranked for restoration feasibility based on land use and susceptibility to invasive plants. PRWs are also ranked based on these categories, individually (see below).  <br> This information helps to distinguish which PRWs have fewer obstacles to restoration and merit further assessment at the site level. None of the feasibility factors preclude wetland restoration.  <br> <a style='color:blue;' href='https://nascience.s3-us-west-1.amazonaws.com/apps/wisconsin_wbd_data/WbD_PRW_Feasibility_Guidance-012021.pdf' target='_blank'>View in report</a>",
