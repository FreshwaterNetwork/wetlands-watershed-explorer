...
// search box function for main search area /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			searchFunction: function(t){
				...
				sources.push({
		            featureLayer: new FeatureLayer("https://cirrus.tnc.org/arcgis/rest/services/FN_Wisconsin/ScoringExplore_All/MapServer/48"),
				...
				sources.push({
		            featureLayer: new FeatureLayer("https://cirrus.tnc.org/arcgis/rest/services/FN_Wisconsin/ScoringExplore_All/MapServer/4"),
		            searchFields: ["name"],
		            displayField: "name",
		            exactMatch: false,
		            outFields: ["name"],
...
// reset opacity values /////////////////////////////////////////////////////////////////////////////////////
			...
			infographicText: function(t){
				t.infographicText = {
					...
					"All-Guild Restoration Opportunities":"All-Guild Restoration Opportunities - Restorable wetlands may have the potential to provide habitat for multiple guilds, depending on the habitat type restored and its proximity to core guild habitat.<br><a style='color:blue;' href='plugins/wetlands-watershed-explorer/assets/WetlandsByDesign_FinalReport.pdf#page=25' target='_blank'>View in report</a>",
				}
			},
// Make vars //////////////////////////////////////////////////////////////////////////////////////////////////
